  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          230 đường Man Thiện, TP. thủ đức, TP. Hồ Chí Minh
        </Text>
      </View>
      ...
      >
        ...
        >
          ...
          >
            Số lượng: <Text style={{ fontWeight: "normal" }}>1000 kg gạo</Text>
          </Text>
        </View>
      </View>
      ...
      >
        ...
        >
          • Vào lúc 5:00AM 19/09/2021 đã mua 100 bao gạo, mỗi bao 50kg giá
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text
              style={[styles.modalText, { fontSize: 15, fontWeight: "bold" }]}
            >
              Bạn muốn từ chối hoạt động này?
            </Text>
